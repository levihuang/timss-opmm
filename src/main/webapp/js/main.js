...
function adjust()
{
	...
	$("#mainframe_bottom").css("height",scn_height - 90);
	$("#mainframe_navtree").css("height",scn_height - 90);
	$("#btn_tree_fold").css("top",(scn_height - 90-60)/2+90);	
...
function go(url)
{
	document.getElementById('mainframe_content').src = url;
}
...
$(document).ready(function(){
	...
	$(".itcui_navtree_grouptitle").click(function(){
		...
		//收起其他的选项卡
		$(".itcui_navtree_grouptitle").removeClass("itcui_navtree_grouptitle_expand");
		$(".navtree_subitem").hide();
		if(is_fold)
		{
			$("#" + box_id).slideDown();
