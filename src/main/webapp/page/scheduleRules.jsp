...
<script>
	...
	$(document).ready(function() {
		...
		for (var j = 0; j < 2; j++) {
			newrow(j);
			$('#td' + j + '_2').html("运行排班");
			$('#td' + j + '_3').html("A值,B值,C值,D值,E值");
			$('#td' + j + '_4').html("5");
			$('#td' + j + '_5').html("早班,中班,夜班,休息");
			$('#td' + j + '_6').html("4");
			$('#td' + j + '_7').html("3");
		}
	...
	<div id="content">
		...
		<table class="itcui_table" style="clear: both" width="100%"
			...
			<tr style="height: 24px">
				...
				<th width="26">序号</th>
				<th width="60">规则编号</th>
				<th width="80" class="th_sortable">规则名称<img
					style="margin-left: 4px" src="${baseURL }/images/arrow_ascend.png" /></th>
				<th width="120" class="th_sortable">值别</th>
				<th width="30" class="th_sortable">值别数</th>
				<th width="120" class="th_sortable">班次</th>
				<th width="30" class="th_sortable">班次数</th>
				<th width="30" class="th_sortable">轮换周期</th>
			</tr>
